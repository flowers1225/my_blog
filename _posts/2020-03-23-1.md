...
### 换肤功能
  ...
  <!-- <video class="video" src="http://www.flowers1225.com/demo/threejs-car/img/1.mp4" webkit-playsinline="" playsinline="" preload="preload" width="600" height="auto" controls="controls" style="display:block;width:600px; margin:0 auto;"></video> -->
...
- ***重影动画***
  ...
  <!-- <video class="video" src="http://www.flowers1225.com/demo/threejs-car/img/2.mp4" webkit-playsinline="" playsinline="" preload="preload" width="600" height="auto" controls="controls" style="display:block;width:600px; margin:0 auto;"></video> -->
<div style="margin:20px auto 0">
